...
int main(int argc, char* argv[])
{
    ...
    if (pid == 0) {
        ...
        printf("Process %d (indices 0-%d): Sum = %d\n", pid, elements_per_process - 1, sum);
        ...
        printf("Process %d (indices %d-%d): Sum = %d\n", pid, (pid * elements_per_process), ((pid + 1) * elements_per_process) - 1, partial_sum);
