 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://newwebservice.com/", wsdlLocation = "http://localhost:8080/WebApplication2/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://newwebservice.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication2/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://newwebservice.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://newwebservice.com/", "NewWebServicePort"), NewWebService.class, features);
    }
