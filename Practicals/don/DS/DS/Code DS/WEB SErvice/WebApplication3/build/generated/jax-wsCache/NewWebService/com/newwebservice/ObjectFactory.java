 ...
 * generated in the com.newwebservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Calculate_QNAME = new QName("http://newwebservice.com/", "calculate");
    private final static QName _CalculateResponse_QNAME = new QName("http://newwebservice.com/", "calculateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.newwebservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://newwebservice.com/", name = "calculate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://newwebservice.com/", name = "calculateResponse")
